"""
Application Vercel ULTRA-LÉGÈRE pour le chatbot de grossesse
Version sans Django - juste des fonctions Python pures
"""
...
def handler(request, context):
    ...
    try:
        ...
        if path.startswith('/chatbot/api/') and method == 'POST':
            ...
            return create_response({
                "status": "healthy",
                "service": "Chatbot Grossesse API (Version Ultra-Légère)",
                "version": "3.0.0",
                "note": "Sans Django - Modèles chargés depuis URLs externes"
            })
            ...
            <html>
            <head>
                <title>Chatbot Grossesse API - Version Ultra-Légère</title>
                <meta charset="utf-8">
                <style>
            ...
            <body>
                <div class="container">
                    <h1>🤰 Chatbot Grossesse API - Version Ultra-Légère</h1>
                    <p>API intelligente pour l'accompagnement des femmes enceintes</p>
                    
                    <div class="success">
                        <h3>✅ Déployé avec succès sur Vercel !</h3>
                        <p>Cette version ultra-légère respecte la limite de 250 MB de Vercel.</p>
                    </div>
                    
                    <div class="warning">
                        <h3>⚠️ Version Ultra-Légère</h3>
                        <p>Cette version fonctionne sans Django pour réduire la taille. Les modèles IA sont chargés depuis des URLs externes.</p>
                    </div>
